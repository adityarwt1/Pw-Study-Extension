...
const DarkThemScriptForPw = () => {
    ...
    try {
      ...
      await excuteScript(tabInfor.id, () => {
        ...
        function fix_containers() {
          ...
          var pwlogo = document.getElementsByClassName("mouse_pointer")[0] as HTMLElement;
          ...
          if (pwlogo.style.filter  === "") {
            pwlogo.style.filter = "invert(0) hue-rotate(180deg)";
          } else {
            pwlogo.style.filter = "";
          }
        }
        ...
        document.onkeyup = function (e) {
          var evt =( window.event || e )as KeyboardEvent;
  ...
  return (
    <button onClick={handleDarkTheme} title="Switch Theme">
      Switch Theme
    </button>
  )
};
